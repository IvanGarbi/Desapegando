...
builder.Services.AddHttpClient<Desapegando.Application.Services.MVC.ICampanhaService, Desapegando.Application.Services.MVC.CampanhaService>().AddHttpMessageHandler<HttpClientAuthorizationDelegatingHandler>();
builder.Services.AddHttpClient<Desapegando.Application.Services.MVC.IAdministradorService, Desapegando.Application.Services.MVC.AdministradorService>().AddHttpMessageHandler<HttpClientAuthorizationDelegatingHandler>();
builder.Services.AddHttpClient<Desapegando.Application.Services.MVC.ICompraService, Desapegando.Application.Services.MVC.CompraService>().AddHttpMessageHandler<HttpClientAuthorizationDelegatingHandler>();
